    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      for (let i = 0; i < formElements.length; i++) {
        ...
        if (field.tagName === 'INPUT' || field.tagName === 'TEXTAREA' || field.tagName === 'SELECT') {
          ...
          // Phone validation (if type is tel)
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אודליה אופל מאמנת השפעה ומכירות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd6bf2452-9778-44f9-99b9-d8f4cf1def97',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd6bf2452-9778-44f9-99b9-d8f4cf1def97';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd6bf2452-9778-44f9-99b9-d8f4cf1def97';
